...
export default class UserList extends React.Component {
  ...
  dragStart = (e: any) => {
    ...
    this.suggestedCell = count
    element.style.backgroundColor = 'yellowgreen'
  }

  // On Drag End
  dragEnd = (e: any) => {
    document.getElementById('dropable_' + this.suggestedCell).style.backgroundColor = '#ffffff'
  }

  render() {
    return (
      this.state.users.map(user =>
        <div className="user" id={user.id} key={user.id} draggable={true} onDragStart={this.dragStart} onDragEnd={this.dragEnd}>
